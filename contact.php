...
//   $users;
  ...
  $email;
    ...
    $sql = "INSERT INTO `mydb`.`feed` (`name`, `email`, `subject`, `message`, `dt`) VALUES ('$name', '$email', '$subject', '$message', current_timestamp());";
    // echo $sql;
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						...
						<ul class="contact-details">
							<li><i class="fa fa-user-circle-o"></i>Subin, Shriya, Reetu</li>
							<li><i class="fa fa-envelope"></i>careerhub@gmail.com</li>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="footer-logo">
							<a class="logo" style="font-size: 30px;" href="main.php">CareerHub</a>
						</div>
					</div>
					<!-- footer logo -->
